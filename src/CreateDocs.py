...
def runCreateDocs(resourcesProvider: ResourcesProvider, chosenDeal: str, chosenEmployeeOar: str):
    ...
    def formDocs():
        if box_01.get() == False and box_02.get() == False and box_03.get() == False and box_04.get() == False and \
            ...
            context = {"number_case": number_case, "day_init" : day_init, "month_init" : month_init, "code_part" : code_part,
                       "code_art" : code_art,
                       ...
                       "zp_position_dp" : zp_position_dp, "zp_position_vp" : zp_position_vp, "zp_position_tp" : zp_position_tp,
...
#готов
            if box_01.get():
                if znt_to_ar_name.get() == '' or day_to_ar.get() == '' or month_to_ar.get() == '':
                    ...
                    znt_to_ar_ip = dapJson['signers'][znt_to_ar_name.get()]['znt_ip']
...
#готов
            if box_02.get():
                if znt_to_ar_name.get() == '' or day_to_ar.get() == '' or month_to_ar.get() == '':
                    ...
                    znt_to_ar_rp_low = dapJson['signers'][znt_to_ar_name.get()]['znt_rp_low']
                    znt_to_ar_name_rp = dapJson['signers'][znt_to_ar_name.get()]['rp']
                    doc = DocxTemplate("../templates/02.docx")
                    context.update({"znt_to_ar_rp_low" : znt_to_ar_rp_low, "znt_to_ar_name_rp" : znt_to_ar_name_rp,
                                    "day_to_ar" : day_to_ar.get(), "month_to_ar" : month_to_ar.get()})
                    doc.render(context)
                    doc.save("../buffer/" + number_case + "__ 2.2 ОПРЕДЕЛЕНИЕ о принятии дела к своему проиводству.docx")
...
#готов
            if box_03.get():
                if day_istreb.get() == '' or month_istreb.get() == '':
                    ...
                    month_init_numeral = dapJson['months'][month_init]
                    ...
                    doc.render(context)
                    doc.save("../buffer/" + number_case + "__ 2.3 ОПРЕДЕЛЕНИЕ об истребовании документов и сведений.docx")
...
#готов
            if box_04.get():
                if day_istreb.get() == '' or month_istreb.get() == '' or day_opros.get() == '' or month_opros.get() == '' \
                    ...
                    context.update({"day_istreb" : day_istreb.get(), "month_istreb" : month_istreb.get(), "day_opros" : day_opros.get(),
                                    "month_opros" : month_opros.get(), "hour_opros" : hour_opros.get(), "min_opros" : min_opros.get(),
...
#готов
            if box_05.get():
                if znt_zapros_name.get() == '':
                    ...
                    znt_zapros_ip = dapJson['signers'][znt_zapros_name.get()]['znt_ip']
                    rank = dapJson['signers'][znt_zapros_name.get()]['rank']
                    doc = DocxTemplate("../templates/05.docx")
                    context.update({"znt_zapros_ip" : znt_zapros_ip, "znt_zapros_name_ip" : znt_zapros_name.get(), "rank" : rank})
                    doc.render(context)
...
#готов
            if box_06.get():
                if znt_zapros_name.get() == '' or day_zapros.get() == '' or month_zapros.get() == '':
                    ...
                    znt_zapros_ip = dapJson['signers'][znt_zapros_name.get()]['znt_ip']
                    znt_zapros_name_ip_full = dapJson['signers'][znt_zapros_name.get()]['ip_full']
                    rank = dapJson['signers'][znt_zapros_name.get()]['rank']
                    cert_ser = dapJson['signers'][znt_zapros_name.get()]['cert_ser']
                    cert_num = dapJson['signers'][znt_zapros_name.get()]['cert_num']
                    cert_day = dapJson['signers'][znt_zapros_name.get()]['cert_day']
                    cert_month = dapJson['signers'][znt_zapros_name.get()]['cert_month']
                    cert_year = dapJson['signers'][znt_zapros_name.get()]['cert_year']
                    ...
                    context.update({"znt_zapros_ip" : znt_zapros_ip, "znt_zapros_name_ip" : znt_zapros_name.get(),
                                    ...
                                    "cert_num" : cert_num, "cert_day" : cert_day, "cert_month" : cert_month, "cert_year" : cert_year})
                    doc1.render(context)
                    doc2.render(context)
...
#готов
            if box_10.get():
                if day_protokol3.get() == '' or month_protokol3.get() == '' or day_to_rassm.get() == '' or month_to_rassm.get() == ''\
                    ...
                    znt_to_rassm_ip = dapJson['signers'][znt_to_rassm_name.get()]['znt_ip']
                    znt_to_rassm_dp = dapJson['signers'][znt_to_rassm_name.get()]['znt_dp']
                    znt_to_rassm_name_dp = dapJson['signers'][znt_to_rassm_name.get()]['dp']
                    rank = dapJson['signers'][znt_to_rassm_name.get()]['rank']
                    rank_dp = dapJson['signers'][znt_to_rassm_name.get()]['rank_dp']
                    ...
                    context.update({"day_protokol3" : day_protokol3.get(), "month_protokol3" : month_protokol3.get(),
                                    ...
                                    "znt_to_rassm_name_ip" : znt_to_rassm_name.get(), "znt_to_rassm_name_dp" : znt_to_rassm_name_dp,
...
#готов
            if box_11.get():
                if znt_to_rassm_name.get() == '' or day_to_rassm.get() == '' or month_to_rassm.get() == '':
                    ...
                    context.update({"znt_to_rassm_ip" : znt_to_rassm_ip, "znt_to_rassm_name_ip" : znt_to_rassm_name.get(), "rank" : rank,
                                    "day_to_rassm" : day_to_rassm.get(), "month_to_rassm" : month_to_rassm.get()})
                    doc.render(context)
            ...
            if box_13.get():
                if znt_to_rassm_name.get() == '' or day_rassm1.get() == '' or month_rassm1.get() == '' or hour_rassm1.get() == ''\
                    ...
                    context.update({"znt_to_rassm_ip" : znt_to_rassm_ip, "znt_to_rassm_name_ip" : znt_to_rassm_name.get(),
                                    "day_rassm1" : day_rassm1.get(), "month_rassm1" : month_rassm1.get(), "hour_rassm1" : hour_rassm1.get(),
...
#готов
            ...
            if box_15.get():
                znt_otlozh_ip = dapJson['signers'][znt_otlozh_name.get()]['znt_ip']
...
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    labelframeToAR = LabelFrame(scrollable_body, text="Передача дела об АП для проведения административного расследования", fg = "blue", bg = "#37faac", labelanchor = "n", padx = 5, pady = 5)
...
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    labelframeZapros1 = LabelFrame(scrollable_body, text = "Запросы в ходе административного расследования", fg = "blue", bg = "#7affca", labelanchor = "n", padx = 5, pady = 5)
...
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    labelframeToRassm = LabelFrame(scrollable_body, text = "Передача дела об АП на рассмотрение", fg = "blue", bg = "#C1F1B1", labelanchor = "n", padx = 5, pady = 5)
...
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    labelframeOtlozh = LabelFrame(scrollable_body, text = "Отложение рассмотрения дела об АП", fg = "blue", bg = "#D7FFD7", labelanchor = "n", padx = 5, pady = 5)
...
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    labelframePost = LabelFrame(scrollable_body, text = "Рассмотрение дела об АП", fg = "blue", bg = "#ebfff7", labelanchor = "n", padx = 5, pady = 5)
...
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    Button(text="Сформировать", command=formDocs).pack(pady = 10)


    with open(resourcesProvider.get_deals_path(), 'r', encoding='utf-8') as readNumbers:
        numbersJson = json.load(readNumbers)

    number_case = chosenDeal
    code_art = numbersJson[number_case]['code_art']
    code_part = numbersJson[number_case]['code_part']
    ...
    day_init = numbersJson[number_case]['day_init']
    date_reg = numbersJson[number_case]['company']['date_reg']
    company_email = numbersJson[number_case]['company']['email']
    inn = numbersJson[number_case]['company']['inn']
    kpp = numbersJson[number_case]['company']['kpp']
    month_init = numbersJson[number_case]['month_init']
    number_dt = numbersJson[number_case]['number_dt']
    ogrn = numbersJson[number_case]['company']['ogrn']

    company_name = numbersJson[number_case]['company']['name']
    city = numbersJson[number_case]['company']['address']['city']
    index = numbersJson[number_case]['company']['address']['index']
    street = numbersJson[number_case]['company']['address']['street']
    state = numbersJson[number_case]['company']['address']['state']

    zp_name_ip = numbersJson[number_case]['company']['representative']['name']
    ...
    zp_position = numbersJson[number_case]['company']['representative']['position']
    zp_position_ip = dapJson['actionerPositions'][zp_position]['ip']
    zp_position_rp = dapJson['actionerPositions'][zp_position]['rp']
    zp_position_dp = dapJson['actionerPositions'][zp_position]['dp']
    zp_position_vp = dapJson['actionerPositions'][zp_position]['vp']
    zp_position_tp = dapJson['actionerPositions'][zp_position]['tp']
    zp_position_ip_low = dapJson['actionerPositions'][zp_position]['ip_low']
    zp_position_rp_low = dapJson['actionerPositions'][zp_position]['rp_low']
    zp_position_dp_low = dapJson['actionerPositions'][zp_position]['dp_low']
    zp_position_vp_low = dapJson['actionerPositions'][zp_position]['vp_low']
    zp_position_tp_low = dapJson['actionerPositions'][zp_position]['tp_low']
